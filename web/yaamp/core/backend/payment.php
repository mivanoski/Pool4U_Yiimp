...
function BackendCoinPayments($coin)
{
    ...
    //Changed from Pool4U
    if ($coin->symbol == 'BZX' || $coin->symbol == 'ZOC' || $coin->symbol == 'PGN' || $coin->symbol == 'SCRIV' || $coin->symbol == 'GENIX' || $coin->symbol == 'SOV' || $coin->symbol == 'GOLD' || $coin->symbol == 'SNARK' || !empty($coin->payout_max))
    {
